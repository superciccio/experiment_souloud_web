...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    WebPlatformException: function WebPlatformException(t0, t1, t2, t3) {
      var _ = this;
      _.code = t0;
      _.message = t1;
      _.exception = t2;
    ...
    getLogger(className) {
      var t1 = new A.LogAllTheTimeFilter(),
        t2 = new A.SimpleLogPrinter(className, true, false, B.List_empty, null),
        t3 = new A.MultipleLoggerOutput(A._setArrayType([new A.DevLogOutput()], type$.JSArray_LogOutput)),
        t4 = new A.Logger(t1, t2, t3),
        filterInit = t1.init$0();
      t4.__Logger__initialization_F = A.Future_wait(A._setArrayType([filterInit, t2.init$0(), t3.init$0()], type$.JSArray_Future_void), type$.void);
      return t4;
    },
    LoggerMixin: function LoggerMixin() {
    },
    SimpleLogPrinter: function SimpleLogPrinter(t0, t1, t2, t3, t4) {
      var _ = this;
      _.className = t0;
      _.printCallingFunctionName = t1;
      _.printCallStack = t2;
      _.exludeLogsFromClasses = t3;
      _.showOnlyClass = t4;
    },
    SimpleLogPrinter_log_closure: function SimpleLogPrinter_log_closure(t0) {
      this.$this = t0;
    },
    MultipleLoggerOutput: function MultipleLoggerOutput(t0) {
      this.logOutputs = t0;
    },
    LogAllTheTimeFilter: function LogAllTheTimeFilter() {
      this._level = null;
    },
    DevLogOutput: function DevLogOutput() {
    },
    DevLogOutput_output_closure: function DevLogOutput_output_closure() {
    },
    DevLogOutput_output_closure0: function DevLogOutput_output_closure0() {
    },
    ...
    getWebWorkerMethodChannel(scriptURL, worker) {
      var $constructor,
        t1 = self,
        t2 = type$.Object,
        t3 = t2._as(t1.self),
        t4 = type$.JSObject;
      t4._as(t1);
      $constructor = type$.nullable_JavaScriptFunction._as(t1.Window);
      if ($constructor != null && t3 instanceof $constructor)
        return A.WebWorkerMethodChannelWeb$(new A.WorkerImpl(t4._as(new t1.Worker(scriptURL))));
      return A.WebWorkerMethodChannelWeb$(new A.WorkerImplSelf(t4._as(t2._as(t1.self))));
    },
    WebWorkerMethodChannelWeb$(worker) {
      var t1 = new A.WebWorkerMethodChannelWeb(worker, A.LinkedHashMap_LinkedHashMap$_empty(type$.int, type$.Completer_nullable_Object), A.LinkedHashMap_LinkedHashMap$_empty(type$.String, type$.List_of_dynamic_Function_nullable_Object));
      t1.WebWorkerMethodChannelWeb$1$worker(worker);
      return t1;
    },
    WebWorkerMethodChannelWeb: function WebWorkerMethodChannelWeb(t0, t1, t2) {
      this.worker = t0;
      this.requests = t1;
      this.methodCallHandlers = t2;
    },
    WebWorkerMethodChannelWeb_closure: function WebWorkerMethodChannelWeb_closure(t0) {
      this.$this = t0;
    },
    _WebWorkerMethodChannelWeb_Object_LoggerMixin: function _WebWorkerMethodChannelWeb_Object_LoggerMixin() {
    },
    Worker0: function Worker0() {
    },
    _WorkerBaseImp: function _WorkerBaseImp() {
    },
    _WorkerBaseImp_addEventListener_closure: function _WorkerBaseImp_addEventListener_closure(t0) {
      this.listener = t0;
    },
    _WorkerBaseImp_addEventListener_closure0: function _WorkerBaseImp_addEventListener_closure0(t0) {
      this.onError = t0;
    },
    WorkerImpl: function WorkerImpl(t0) {
      this.worker = t0;
    },
    WorkerImplSelf: function WorkerImplSelf(t0) {
      this.self = t0;
    },
    _WorkerImpl_Worker__WorkerBaseImp: function _WorkerImpl_Worker__WorkerBaseImp() {
    },
    _WorkerImplSelf_Worker__WorkerBaseImp: function _WorkerImplSelf_Worker__WorkerBaseImp() {
    },
    AnsiColor$fg(fg) {
      return new A.AnsiColor(fg, true);
    },
    AnsiColor_grey(level) {
      return 232 + B.JSNumber_methods.round$0(B.JSNumber_methods.clamp$2(level, 0, 1) * 23);
    },
    ...
    HostPlatform: function HostPlatform() {
    },
    ExtendedHostPlatform: function ExtendedHostPlatform() {
    },
    BuildMode: function BuildMode(t0) {
      this._name = t0;
    },
    HostPlatformType: function HostPlatformType(t0) {
      this._name = t0;
    },
    OperatingSystem: function OperatingSystem(t0) {
      this._name = t0;
    },
    PlatformMethods: function PlatformMethods() {
    },
    Platform__getCurrentBuildMode() {
      return new A.Platform__getCurrentBuildMode_closure().call$0();
    },
    Platform: function Platform(t0) {
      this._hostPlatform = t0;
    },
    Platform__getCurrentBuildMode_closure: function Platform__getCurrentBuildMode_closure() {
    },
    _Platform_ExtendedHostPlatform_PlatformMethods: function _Platform_ExtendedHostPlatform_PlatformMethods() {
    },
    _HostPlatform$Web__isUnknownEnvironment() {
      return false;
    },
    _HostPlatform$Web__getOS() {
      A._HostPlatform$Web__isUnknownEnvironment();
      var appVersion = A._HostPlatform$Web__getVersion().toLowerCase();
      if (B.JSString_methods.contains$1(appVersion, "fuchsia"))
        return B.OperatingSystem_fuchsia;
      else if (B.JSString_methods.contains$1(appVersion, "mac"))
        return B.OperatingSystem_macOS;
      else if (B.JSString_methods.contains$1(appVersion, "win"))
        return B.OperatingSystem_windows;
      else if (B.JSString_methods.contains$1(appVersion, "android"))
        return B.OperatingSystem_android;
      else if (B.JSString_methods.contains$1(appVersion, "iphone"))
        return B.OperatingSystem_iOS;
      else if (B.JSString_methods.contains$1(appVersion, "ios"))
        return B.OperatingSystem_iOS;
      else if (B.JSString_methods.contains$1(appVersion, "linux"))
        return B.OperatingSystem_linux;
      return B.OperatingSystem_unknown;
    },
    _HostPlatform$Web__getVersion() {
      var t2, t3,
        t1 = window.navigator.userAgent;
      t1.toString;
      t2 = window.navigator.appVersion;
      t2.toString;
      t3 = window.navigator.platform;
      return B.JSArray_methods.firstWhere$2$orElse(A._setArrayType([t1, t2, t3 == null ? "" : t3], type$.JSArray_String), new A._HostPlatform$Web__getVersion_closure(), new A._HostPlatform$Web__getVersion_closure0());
    },
    _HostPlatform$Web__numberOfProcessors() {
      A._HostPlatform$Web__isUnknownEnvironment();
      var numberOfProcessors = window.navigator.hardwareConcurrency;
      if (numberOfProcessors != null)
        return numberOfProcessors;
      return 0;
    },
    _HostPlatform$Web__getLocale() {
      var lang,
        t1 = window.navigator;
      t1.toString;
      lang = J.trim$0$s(B.JSArray_methods.get$first(J.split$1$s(B.JSArray_methods.get$first((t1.language || t1.userLanguage).split("-")), "_"))).toLowerCase();
      A._HostPlatform$Web__isUnknownEnvironment();
      if (lang.length !== 2)
        return "en";
      return lang;
    },
    _HostPlatform$Web: function _HostPlatform$Web(t0, t1, t2, t3) {
      var _ = this;
      _.operatingSystem = t0;
      _.version = t1;
      _.locale = t2;
      _.numberOfProcessors = t3;
    },
    _HostPlatform$Web__getVersion_closure: function _HostPlatform$Web__getVersion_closure() {
    },
    _HostPlatform$Web__getVersion_closure0: function _HostPlatform$Web__getVersion_closure0() {
    },
    printString(string) {
    ...
    main() {
      var $async$goto = 0,
        ...
        channel, t1, t2, t3, t4, i, t5, requestId;
      var $async$main = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              A.print("worker_js.dart init");
              channel = A.getWebWorkerMethodChannel("echo", null);
              for (t1 = type$._Future_nullable_Object, t2 = type$._AsyncCompleter_nullable_Object, t3 = channel.requests, t4 = channel.worker, i = 0; i <= 20; ++i) {
                t5 = B.JSInt_methods.toString$0(i);
                A.getLogger(A.getRuntimeTypeOfDartObject(channel).toString$0(0) + " worker.isMainThread:" + t4.get$isMainThread()).log$5$error$stackTrace$time(B.Level_3000_info, t5, null, null, null);
                requestId = B.C__JSRandom.nextInt$1(2147483647);
                t3.$indexSet(0, requestId, new A._AsyncCompleter(new A._Future($.Zone__current, t1), t2));
                t4.postMessage$1(0, new A.Message(requestId, "echo", t5, null));
              }
              // implicit return
  ...
  A.WebPlatformException.prototype = {
    toString$0(_) {
      var _this = this;
      return "WebPlatformException(code: " + _this.code + ", message: " + A.S(_this.message) + ", exception: " + A.S(_this.exception) + ", stacktrace: " + A.S(_this.stacktrace) + ")";
    }
  };
  A.LoggerMixin.prototype = {};
  A.SimpleLogPrinter.prototype = {
    _labelFor$1(level) {
      var prefix = $.$get$SimplePrinter_levelPrefixes().$index(0, level),
        color = $.$get$SimplePrinter_levelColors().$index(0, level);
      if (prefix == null)
        return "";
      if (color == null)
        return prefix;
      return color.call$1(prefix);
    },
    log$1($event) {
      var t6, result, _i, err, _this = this,
        now = new A.DateTime(Date.now(), false),
        t1 = _this._labelFor$1($event.level),
        t2 = B.JSString_methods.padLeft$2(B.JSInt_methods.toString$0(A.Primitives_getHours(now)), 2, "0"),
        t3 = B.JSString_methods.padLeft$2(B.JSInt_methods.toString$0(A.Primitives_getMinutes(now)), 2, "0"),
        t4 = B.JSString_methods.padLeft$2(B.JSInt_methods.toString$0(A.Primitives_getSeconds(now)), 2, "0"),
        t5 = $event.stackTrace;
      J.toString$0$(t5);
      if (!B.JSArray_methods.any$1(_this.exludeLogsFromClasses, new A.SimpleLogPrinter_log_closure(_this)))
        t6 = false;
      else
        t6 = true;
      if (t6)
      ...
      for (t1 = (t1 + " [" + t2 + ":" + t3 + ":" + t4 + "] " + _this.className + " - " + $event.message).split("\n"), t2 = t1.length, _i = 0; _i < t2; ++_i)
        B.JSArray_methods.add$1(result, t1[_i]);
      err = $event.error;
      t1 = A._setArrayType([], t6);
      if (err != null)
        B.JSArray_methods.addAll$1(t1, A._setArrayType(["error:", J.toString$0$(err)], t6));
      if (t5 != null)
        B.JSArray_methods.addAll$1(t1, A._setArrayType(["stackTrace:", t5.toString$0(0)], t6));
      B.JSArray_methods.addAll$1(result, t1);
      return result;
    }
  };
  A.SimpleLogPrinter_log_closure.prototype = {
    call$1(excludeClass) {
      return this.$this.className === A._asString(excludeClass);
    },
    $signature: 7
  };
  A.MultipleLoggerOutput.prototype = {
    output$1($event) {
      var logOutput, t1, _i, exception;
      for (t1 = this.logOutputs, _i = 0; _i < 1; ++_i) {
        logOutput = t1[_i];
        try {
          logOutput.output$1($event);
        } catch (exception) {
        }
      }
    }
  };
  A.LogAllTheTimeFilter.prototype = {
    shouldLog$1($event) {
      return true;
    }
  };
  A.DevLogOutput.prototype = {
    output$1($event) {
      var logFunction = new A.DevLogOutput_output_closure();
      if (this.get$_isIO())
        logFunction = new A.DevLogOutput_output_closure0();
      B.JSArray_methods.forEach$1($event.lines, logFunction);
    },
    get$_isIO() {
      var exception;
      try {
  ...
  A.DevLogOutput_output_closure.prototype = {
    call$1(message) {
      return A.print(A._asString(message));
    },
    $signature: 8
  };
  A.DevLogOutput_output_closure0.prototype = {
    call$1(message) {
      return A.log(A._asString(message));
    },
    $signature: 8
  };
  A.Message.prototype = {
    toString$0(_) {
      var _this = this;
      return "Message(requestId: " + _this.requestId + ", method: " + _this.method + ", body: " + A.S(_this.body) + ", exception: " + A.S(_this.exception) + ")";
    },
    toMap$0() {
      var _this = this,
        t1 = _this.exception;
      t1 = t1 == null ? null : A.LinkedHashMap_LinkedHashMap$_literal(["code", t1.code, "message", t1.message, "exception", t1.exception, "stacktrace", J.toString$0$(t1.stacktrace)], type$.String, type$.dynamic);
      return A.LinkedHashMap_LinkedHashMap$_literal(["requestId", _this.requestId, "method", _this.method, "body", _this.body, "exception", t1], type$.String, type$.dynamic);
    }
  };
  A.WebWorkerMethodChannelWeb.prototype = {
    WebWorkerMethodChannelWeb$1$worker(worker) {
      var t1 = this.worker;
      t1.get$isMainThread();
      t1.addEventListener$1(0, new A.WebWorkerMethodChannelWeb_closure(this));
    }
  };
  A.WebWorkerMethodChannelWeb_closure.prototype = {
    call$1(data) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$returnValue, $async$self = this, error, completer, method, requestId, t1, t2;
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              t1 = $async$self.$this;
              t2 = t1.requests;
              if (t2.containsKey$1(0, requestId)) {
                error = data.exception;
                completer = t2.remove$1(0, requestId);
                if (error != null) {
                  completer.completeError$1(error);
                  // goto return
                  $async$goto = 1;
                  break;
                }
                completer.complete$1(0, data.body);
                // goto return
                $async$goto = 1;
                break;
              }
              t1.methodCallHandlers.$index(0, method);
              A.getLogger(A.getRuntimeTypeOfDartObject(t1).toString$0(0) + " worker.isMainThread:" + t1.worker.get$isMainThread()).log$5$error$stackTrace$time(B.Level_4000_warning, "No handlers for method " + method, null, null, null);
              // goto return
              $async$goto = 1;
              break;
            case 1:
  ...
  A._WebWorkerMethodChannelWeb_Object_LoggerMixin.prototype = {};
  A.Worker0.prototype = {};
  A._WorkerBaseImp.prototype = {
    addEventListener$1(_, listener) {
      var _this = this,
        _s16_ = "addEventListener",
        _s19_ = "removeEventListener",
        t1 = type$.Function,
        t2 = type$.JavaScriptFunction,
        listenerJS = t2._as(A.allowInterop(new A._WorkerBaseImp_addEventListener_closure(type$.void_Function_Message._as(listener)), t1)),
        onErrorJS = t2._as(A.allowInterop(new A._WorkerBaseImp_addEventListener_closure0(null), t1));
      t1 = type$.void;
      A.callMethod(_this.get$eventTarget(), _s16_, ["message", listenerJS], t1);
      A.callMethod(_this.get$eventTarget(), _s16_, ["error", onErrorJS], t1);
      A.callMethod(_this.get$eventTarget(), _s19_, ["message", listenerJS], t1);
      A.callMethod(_this.get$eventTarget(), _s19_, ["error", onErrorJS], t1);
    }
  };
  A._WorkerBaseImp_addEventListener_closure.prototype = {
    call$1(e) {
      var t2, t3, t4, t5, t6, t7, t8,
        _s9_ = "exception",
        _s10_ = "stacktrace",
        t1 = A.dartify(type$.JSObject._as(e).data);
      t1.toString;
      A.print(t1);
      ...
      t4 = A._asInt(t3.$index(t1, "requestId"));
      t5 = A._asString(t3.$index(t1, "method"));
      t6 = t3.$index(t1, "body");
      if (t3.$index(t1, _s9_) == null)
        t1 = null;
      else {
        t1 = t2._as(t3.$index(t1, _s9_));
        t2 = J.getInterceptor$ax(t1);
        t3 = A._asString(t2.$index(t1, "code"));
        t7 = A._asStringQ(t2.$index(t1, "message"));
        t8 = A._asStringQ(t2.$index(t1, _s9_));
        t1 = new A.WebPlatformException(t3, t7, t8, t2.$index(t1, _s10_) == null ? null : new A._StringStackTrace(A._asString(t2.$index(t1, _s10_))));
      }
      this.listener.call$1(new A.Message(t4, t5, t6, t1));
    },
    $signature: 22
  };
  A._WorkerBaseImp_addEventListener_closure0.prototype = {
    call$1(error) {
      type$.Object._as(error);
    },
    $signature: 23
  };
  A.WorkerImpl.prototype = {
    postMessage$1(_, message) {
      A.print(message);
      A.callMethod(this.worker, "postMessage", [A.jsify(message.toMap$0())], type$.void);
    },
    get$eventTarget() {
      return this.worker;
    },
  ...
  A.WorkerImplSelf.prototype = {
    postMessage$1(_, message) {
      A.callMethod(this.self, "postMessage", [A.jsify(message.toMap$0())], type$.void);
    },
    get$eventTarget() {
      return this.self;
    },
  ...
  A._WorkerImpl_Worker__WorkerBaseImp.prototype = {};
  A._WorkerImplSelf_Worker__WorkerBaseImp.prototype = {};
  ...
  A.HostPlatform.prototype = {};
  A.ExtendedHostPlatform.prototype = {};
  A.BuildMode.prototype = {
    _enumToString$0() {
      return "BuildMode." + this._name;
    }
  };
  A.HostPlatformType.prototype = {
    _enumToString$0() {
      return "HostPlatformType." + this._name;
    }
  };
  ...
  A.Platform.prototype = {
    ...
    $eq(_, other) {
      if (other == null)
        return false;
      return other instanceof A.Platform;
    },
    toString$0(_) {
      return "<Platform " + this._hostPlatform.version + ">";
    }
  };
  A.Platform__getCurrentBuildMode_closure.prototype = {
    call$0() {
      return B.BuildMode_1;
    },
    $signature: 24
  };
  A._Platform_ExtendedHostPlatform_PlatformMethods.prototype = {};
  A._HostPlatform$Web.prototype = {};
  A._HostPlatform$Web__getVersion_closure.prototype = {
    call$1(v) {
      A._asString(v);
      A._HostPlatform$Web__isUnknownEnvironment();
      return v.length !== 0;
  ...
  A._HostPlatform$Web__getVersion_closure0.prototype = {
    call$0() {
      return "<unknown>";
    },
    $signature: 25
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, J.ArrayIterator, A.Error, A.SentinelValue, A.Iterable, A.ListIterator, A.MappedIterator, A.FixedLengthListMixin, A.Symbol, A.MapView, A.ConstantMap, A._KeysOrValuesOrElementsIterator, A.SetBase, A.JSInvocationMirror, A.Closure, A.TypeErrorDecoder, A.NullThrownFromJavaScriptException, A.ExceptionAndStackTrace, A._StackTrace, A._Required, A.MapBase, A.LinkedHashMapCell, A.LinkedHashMapKeyIterator, A._Cell, A.Rti, A._FunctionParameters, A._Type, A._TimerImpl, A._AsyncAwaitCompleter, A.AsyncError, A._Completer, A._FutureListener, A._Future, A._AsyncCallbackEntry, A._StreamIterator, A._Zone, A._HashMapKeyIterator, A._LinkedHashSetIterator, A.ListBase, A._UnmodifiableMapMixin, A.DateTime, A._Enum, A.OutOfMemoryError, A.StackOverflowError, A._Exception, A.Null, A._StringStackTrace, A.StringBuffer, A.CssStyleDeclarationBase, A.ImmutableListMixin, A.FixedSizeListIterator, A.NullRejectionException, A._JSRandom, A.WebPlatformException, A.LoggerMixin, A.LogPrinter, A.LogOutput, A.LogFilter, A.Message, A._WebWorkerMethodChannelWeb_Object_LoggerMixin, A.Worker0, A._WorkerBaseImp, A.AnsiColor, A.LogEvent, A.Logger, A.OutputEvent, A.HostPlatform, A.PlatformMethods]);
    ...
    _inheritMany(A.Closure, [A.Closure2Args, A.Closure0Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A._AsyncRun__initializeScheduleImmediate_internalCallback, A._AsyncRun__initializeScheduleImmediate_closure, A._awaitOnObject_closure, A.Future_wait_closure, A._Future__chainForeignFuture_closure, A._Future__propagateToListeners_handleWhenCompleteCallback_closure, A.jsify__convert, A.promiseToFuture_closure, A.promiseToFuture_closure0, A.dartify_convert, A.SimpleLogPrinter_log_closure, A.DevLogOutput_output_closure, A.DevLogOutput_output_closure0, A.WebWorkerMethodChannelWeb_closure, A._WorkerBaseImp_addEventListener_closure, A._WorkerBaseImp_addEventListener_closure0, A._HostPlatform$Web__getVersion_closure]);
    ...
    _inherit(A.SimpleLogPrinter, A.LogPrinter);
    _inheritMany(A.LogOutput, [A.MultipleLoggerOutput, A.DevLogOutput]);
    _inherit(A.LogAllTheTimeFilter, A.LogFilter);
    _inherit(A.WebWorkerMethodChannelWeb, A._WebWorkerMethodChannelWeb_Object_LoggerMixin);
    _inheritMany(A.Worker0, [A._WorkerImpl_Worker__WorkerBaseImp, A._WorkerImplSelf_Worker__WorkerBaseImp]);
    _inherit(A.WorkerImpl, A._WorkerImpl_Worker__WorkerBaseImp);
    _inherit(A.WorkerImplSelf, A._WorkerImplSelf_Worker__WorkerBaseImp);
    _inheritMany(A._Enum, [A.Level, A.BuildMode, A.HostPlatformType, A.OperatingSystem]);
    _inheritMany(A.HostPlatform, [A.ExtendedHostPlatform, A._HostPlatform$Web]);
    _inherit(A._Platform_ExtendedHostPlatform_PlatformMethods, A.ExtendedHostPlatform);
    _inherit(A.Platform, A._Platform_ExtendedHostPlatform_PlatformMethods);
  ...
  var type$ = (function rtii() {
    ...
    return {
      ...
      GeneralConstantSet_OperatingSystem: findType("GeneralConstantSet<OperatingSystem>"),
      ...
      JSArray_LogOutput: findType("JSArray<LogOutput>"),
      ...
      List_of_dynamic_Function_nullable_Object: findType("List<@(Object?)>"),
  ...
  (function constants() {
    ...
    B.BuildMode_1 = new A.BuildMode("profile");
...
;
    ...
    B.HostPlatformType_1 = new A.HostPlatformType("web");
    ...
    B.OperatingSystem_android = new A.OperatingSystem("android");
    B.OperatingSystem_fuchsia = new A.OperatingSystem("fuchsia");
    B.OperatingSystem_iOS = new A.OperatingSystem("iOS");
    B.OperatingSystem_linux = new A.OperatingSystem("linux");
    B.OperatingSystem_macOS = new A.OperatingSystem("macOS");
    B.OperatingSystem_unknown = new A.OperatingSystem("unknown");
    B.OperatingSystem_windows = new A.OperatingSystem("windows");
    B.Set_GVisi = new A.GeneralConstantSet([B.OperatingSystem_android, B.OperatingSystem_fuchsia], type$.GeneralConstantSet_OperatingSystem);
    B.Set_M0o66 = new A.GeneralConstantSet([B.OperatingSystem_android, B.OperatingSystem_iOS], type$.GeneralConstantSet_OperatingSystem);
    B.Set_c0hm = new A.GeneralConstantSet([B.OperatingSystem_windows, B.OperatingSystem_macOS, B.OperatingSystem_fuchsia, B.OperatingSystem_linux], type$.GeneralConstantSet_OperatingSystem);
    B.Set_k6K4 = new A.GeneralConstantSet([B.OperatingSystem_macOS, B.OperatingSystem_iOS], type$.GeneralConstantSet_OperatingSystem);
  ...
  (function lazyInitializers() {
    ...
    _lazyFinal($, "SimplePrinter_levelPrefixes", "$get$SimplePrinter_levelPrefixes", () => A.LinkedHashMap_LinkedHashMap$_literal([B.Level_1000_trace, "[T]", B.Level_2000_debug, "[D]", B.Level_3000_info, "[I]", B.Level_4000_warning, "[W]", B.Level_5000_error, "[E]", B.Level_6000_fatal, "[FATAL]"], A.findType("Level"), type$.String));
    _lazyFinal($, "SimplePrinter_levelColors", "$get$SimplePrinter_levelColors", () => A.LinkedHashMap_LinkedHashMap$_literal([B.Level_1000_trace, A.AnsiColor$fg(A.AnsiColor_grey(0.5)), B.Level_2000_debug, B.AnsiColor_null_false, B.Level_3000_info, B.AnsiColor_12_true, B.Level_4000_warning, B.AnsiColor_208_true, B.Level_5000_error, B.AnsiColor_196_true, B.Level_6000_fatal, B.AnsiColor_199_true], A.findType("Level"), A.findType("AnsiColor")));
    _lazyFinal($, "Platform__this", "$get$Platform__this", () => {
      var t1, t2, t3, t4;
      A.Platform__getCurrentBuildMode();
      t1 = A._HostPlatform$Web__getOS();
      t2 = A._HostPlatform$Web__getVersion();
      t3 = A._HostPlatform$Web__getLocale();
      t4 = A._HostPlatform$Web__numberOfProcessors();
      B.Set_M0o66.contains$1(0, t1);
      B.Set_c0hm.contains$1(0, t1);
      B.Set_GVisi.contains$1(0, t1);
      B.Set_k6K4.contains$1(0, t1);
      return new A.Platform(new A._HostPlatform$Web(t1, t2, t3, t4));
    });
  })();
...
//# sourceMappingURL=worker_js.dart.js.map
